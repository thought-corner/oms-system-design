...
object AlertMessageFormatter {
    ...
    private const val FORWARD_TYPE = "STOCK_BUY"
    private const val CANCEL_TYPE = "STOCK_CANCEL"
    private const val FORWARD_WORK = "재고 차감"
    private const val FORWARD_WORK_SUBJECT = "재고 차감이"
    private const val CANCEL_WORK = "재고 복구"
    private const val CANCEL_WORK_SUBJECT = "재고 복구가"
    private const val FORWARD_UNTOUCHED = "재고는 아직 차감되지 않았습니다"
    private const val CANCEL_LEFTOVER = "재고가 차감된 채 남아 있을 수 있습니다"
    private const val CANCEL_RESTORED = "재고는 자동으로 되돌려지므로"
    private const val ASSET_OBJECT = "재고를"
