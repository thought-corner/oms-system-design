...
object AlertMessageFormatter {
    ...
    private const val FORWARD_TYPE = "PAYMENT_PAY"
    private const val CANCEL_TYPE = "PAYMENT_CANCEL"
    private const val FORWARD_WORK = "결제 승인"
    private const val FORWARD_WORK_SUBJECT = "결제 승인이"
    private const val CANCEL_WORK = "결제 취소"
    private const val CANCEL_WORK_SUBJECT = "결제 취소가"
    private const val FORWARD_UNTOUCHED = "결제는 아직 되지 않았습니다"
    private const val CANCEL_LEFTOVER = "결제가 취소되지 않은 채 남아 있을 수 있습니다"
    private const val CANCEL_RESTORED = "결제는 자동으로 취소되므로"
    private const val ASSET_OBJECT = "결제 내역을"
